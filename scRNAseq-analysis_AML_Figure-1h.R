...
read.csv("genelist_uncommitted.csv", header=TRUE)
Primitive1 = readLines("genelist_uncommitted.csv")
...
read.csv("genelist_primed.csv", header=TRUE)
Diff = readLines("genelist_primed.csv")
